...
* At this point CMR records were created and loaded via a large series of separate scripts, sometimes several per metadata contributor. When the structure of an AIP was created as part of new OAIS archiving, a cmr.xml file (already crosswalked from the metadata record other Canadiana staff supplied) was part of the AIP (See [AIP definition](https://github.com/crkn-rcdr/Digital-Preservation/blob/main/xml/published/schema/2012/txt/aip.txt) )
